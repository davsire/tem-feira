...
class FrameDadosLogin(ctk.CTkFrame):
    ...
    def __init__(self, master):
        ...
        self.email_entry = ctk.CTkEntry(self, height=52.5, placeholder_text='Digite seu e-mail')
        ...
        self.senha_entry = ctk.CTkEntry(self, height=52.5, placeholder_text='Digite sua senha', show='*')
