...
class FrameDadosLogin(ctk.CTkFrame):
    ...
    def __init__(self, master):
        ...
        self.email_label.grid(row=0, column=0, columnspan=1, sticky='w')
        self.email_entry.grid(row=1, column=0, columnspan=1, sticky='new')
        ...
        self.senha_label.grid(row=2, column=0, columnspan=1, sticky='w')
        self.senha_entry.grid(row=3, column=0, columnspan=1, sticky='new')
